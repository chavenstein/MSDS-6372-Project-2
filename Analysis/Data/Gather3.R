...
RigCountByTrajectory <- readWorksheetFromFile(path, sheet = "US Count by Trajectory", header = TRUE, startRow = 6)
...
write.csv(RigCountByTrajectory, file = "RigCountByTrajectory.csv")
